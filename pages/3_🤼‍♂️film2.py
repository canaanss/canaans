...
# ---- Perpare ----
img_Wrestling = Image.open("images/wrestling.jpg")
...
with st.container():
    ...
    with image_column:
    # insert image
        st.image(img_Wrestling)

    with text_column:
        st.subheader("摔跤吧爸爸")
        st.write(
            """
            导演: 涅提·蒂瓦里&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;类型: 剧情 / 家庭 / 传记 / 运动\n
            编剧: 比于什·古普塔 / 施热亚·简 / 尼基尔·麦罗特拉 / 涅提·蒂瓦里\n
            制片国家/地区: 印度\n
            上映日期: 2017-05-05(中国大陆) / 2016-12-23(印度)
            """
        )
        code = '''主演: 阿米尔·汗 / 法缇玛·萨那·纱卡 / 桑亚·玛荷塔 / 阿帕尔夏克提·库拉那 / 
        沙克希·坦沃 / 塞伊拉·沃西 / 苏哈妮·巴特纳格尔 / 里特维克·萨霍里 / 吉里什·库卡尼'''
